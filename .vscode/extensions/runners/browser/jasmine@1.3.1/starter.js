 ...
 */
!function(){var e=window.$_$tracer,t=jasmine.getEnv(),n=new JasmineReporter(e);t.addReporter(n),t.specFilter=function(e){return n.specFilter(e)},e.start(function(){t.execute()})}();